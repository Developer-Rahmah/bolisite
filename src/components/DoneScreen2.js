...
<CardItem style={transparentBackground}>
  <Body style={centerStyle}>
    ...
    {/* <Text style={{fontFamily:'TajawalBold0',lineHeight:25}}>Your order has been submitted successfully</Text> */}
...
<CardItem style={transparentBackground}>
  <Body style={centerStyle}>
    ...
    <Text style={{fontFamily:'TajawalMedium0',lineHeight:25}}>Our team will contact you within the next 48 hours</Text>
...
:
 <CardItem style={transparentBackground}>
  ...
  <Text style={{fontFamily:'TajawalMedium0',lineHeight:25}}>تم إرسال طلبك رقم {this.props.order_id} بنجاح</Text>
   <Text style={{fontFamily:'TajawalMedium0',lineHeight:25}}> سيقوم فريقنا بالاتصال بك خلال 48 ساعة</Text>
