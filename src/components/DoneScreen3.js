...
import  {ImageBackground,Dimensions,Text,StyleSheet,Image,Keyboard,StatusBar,Platform,ScrollView} from 'react-native';
import {Body,CardItem,Button,
...
import {blueBackgroundColor,transparentBackground,centerStyle} from '../theme';
...
<CardItem style={transparentBackground}>
  <Body style={centerStyle}>
    ...
    <Text style={{fontFamily:'TajawalMedium0',lineHeight:25}}>Your application will be reviewed</Text>
    <Text style={{fontFamily:'TajawalMedium0',lineHeight:25}}>and will revert back shortly</Text>
...
<CardItem style={transparentBackground}>
  <Body style={centerStyle}>
    ...
    <Text style={{fontFamily:'TajawalMedium0',lineHeight:25}}>سيتم مراجعة طلبك و سنقوم بالرد عليكم قريبا</Text>
