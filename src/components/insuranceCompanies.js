...
class InsuranceCompanies extends Component {
  ...
  this.props.getInsuranceCompanies(this.props.travelInformation)
  ...
  goToAnotherPage = (addons, insuranceCompaanyId,companyOldPrice,companyDiscountRate, total) => {
    console.log("insuranceCompaanyId00",insuranceCompaanyId)
    var companyAddons = [];
  ...
  showModal = (id, company) => {
    const {addons, show_insurance_modal, category_id,carInformation,travelInformation} = this.props;
    this.setState({insuranceCompanyId: id});
    this.setState({companyOldPrice:company.old_price})
    this.setState({companyDiscountRate:company.discount_rate_travel})
    ...
    this.props.getTerms(id);
    this.props.showInsuranceCompanyModal(!show_insurance_modal);
    Actions.refresh({carInformation:carInformation,travelInformation:travelInformation})
  ...
  render() {
console.log("this.props in insurance company 0000",this.props)
if(Actions.prevScene=="travelinsuranceinformation"){
  typeInsurancee="Travel Insurance"
}
else if(Actions.prevScene=="carinformation"){
  typeInsurancee=="car Insurance"
}
const {
  show_insurance_modal,
  insuranceCompanies,
  ...
  show_pdf_modal,
  show_sort_modal,
  insurancecompaniesTravel,insurance_loading
} = this.props;

 console.log("insurancecompaniesTravel",insurancecompaniesTravel)
          ...
          <Content style={{backgroundColor: "transparent"}}>
            ...
            >
              {lang == "ar" ? (
                ...
                <TouchableOpacity onPress={()=> this.props.showSortingModal(!show_sort_modal)} style={{marginLeft:40}}>
   ...
   fontFamily:'TajawalBlack0',lineHeight:20,marginTop:10}}> {strings("insurancecompanies.sort", lang)}</Text>
                ...
                <View style={{flexDirection:"row"}}>
                              <TouchableOpacity onPress={()=> this.props.showSortingModal(!show_sort_modal)}style={{marginLeft:20}}>
...
{Platform.OS=="ios"?
!insurance_loading?
            insurancecompaniesTravel.length>0
              ? insurancecompaniesTravel.map((company, index) => {
                  return (
                    <TouchableWithoutFeedback
                      onPress={() =>
              ...
              //               </Text>
              //               :null}
              //        {company.old_price!=null&&company.discount_rate_travel!=null?
...
/>
    ...
    <Text style={{fontFamily: "TajawalBold0",fontSize:16,color:"#003580"}}>
             ...
             <View style={{flexDirection:"row"}}>
             {company.old_price!=null&&company.discount_rate_travel!=null&&company.old_price!=0?
...
{'وفرت'} {company.discount_rate_travel}{'%'}
</Text>
:null}
             {company.old_price!=null&&company.end_date_travel!=null&&company.old_price!=0?

             <Text style={{fontFamily: "TajawalBold0",fontSize:15,color:"gray",marginTop:8}}>
                   {' '}{' لغاية: '}{company.end_date_travel}
                  </Text>
                  :null}
              ...
              //               <View style={{width:"50%",justifyContent:"flex-start",alignItems:"flex-start",marginTop:10}}>
              //              {lang=="en"?
     ...
     />
             ...
             {company.old_price!=null&&company.discount_rate_travel!=null&&company.old_price!=0?
                   ...
                   You Save %{company.discount_rate_travel}
                  </Text>
                  :null}
                   {company.old_price!=null&&company.end_date_travel!=null&&company.old_price!=0?
    
                  <Text style={{fontFamily: "TajawalBold0",fontSize:15,color:"gray",marginTop:8}}>
                   {' '}{'Valid Till: '}{company.end_date_travel}
                  </Text>
                  :null}
                  </View>
                  </View>
                  ...
                  // </View>
                  // :
                  // <View style={{marginBottom:10,marginEnd:-40}}>
                  // {lang=="en"?
                      ...
                      {lang == "ar" ? (
                               <View style={{
                                ...
                                direction: "rtl"}}>
                                  ...
                                  <View style={{width:"60%",justifyContent:"flex-end",alignItems:"flex-end",marginBottom:30}}>
                                 {lang=="en"?
    ...
    <Text style={{fontFamily: "TajawalBold0",fontSize:16,color:"#003580"}}>
               ...
               />
                       ...
                       <View style={{flexDirection:"row"}}>
                       {company.old_price!=null&&company.old_price!=0&&company.discount_rate_travel!=null?
          
                             <Text style={{fontFamily: "TajawalBold0",fontSize:15,backgroundColor:"rgb(205,237,215)",color:"green",borderRadius:3,padding:3}}>
                             You Save %{company.discount_rate_travel}
                            </Text>
                            :null}
                             {company.old_price!=null&&company.old_price!=0&&company.end_date_travel!=null?
                ...
                >
                  <CardItem>
                    <Left>
                      <Icon
                        ...
                        name="md-close"
                        onPress={() =>
                          this.props.showInsuranceCompanyModal(
                            !show_insurance_modal
                          )
                        }
                      />
                  ...
                  {terms.length > 0 ? (
                    ...
                    >
                      ...
                      >
                        <Text
                          style={{fontFamily: "TajawalBold0", lineHeight: 20,textAlign:lang=="ar"?"right":"left"}}
                        >
...
<Text style={{color:"#003580",fontSize:16}}>*</Text> 
                ...
                >
                  ...
                  >
                    ...
                    {terms.length > 0 ? (
                      ...
                      >
                        <PDFReader source={{uri: "https://bolisati.com/"+terms[0].travel_terms}} />
                      </View>
                    ) : null}
                  </View>
                  {/* </Content>    */}
            ...
            <Modal
                        animationType="slide"
                        transparent={true}
                        visible={show_sort_modal}
                        onRequestClose={() => {
                          this.props.showSortingModal(!show_sort_modal)
                        }}>
                        <View style={{ marginTop: 350, marginEnd: 20, marginStart: 20, flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                            <Card style={{ borderRadius: 0 }}>
                                  ...
                                  {/* <TouchableOpacity 
                                 onPress={()=>{this.props.showSortingModal(!show_sort_modal)}}
>  
 <Icon style={{color:'white',}} name={
        Platform.OS === 'ios'
          ...
          : 'md-close'
                ...
                <TouchableOpacity  onPress={ () => { this.props.FilterResults(this.props.travelInformation,2,this.props.user_id,this.props.category_id) } } style={{width:'100%',height:44,justifyContent:'center',alignItems:'center'}}>
  ...
  fontStyle: "normal",}}>
              {strings("insurancecompanies.hightolow", lang)}
                ...
                <TouchableOpacity  onPress={ () => { this.props.FilterResults(this.props.travelInformation,1,this.props.user_id,this.props.category_id) } } style={{width:'100%',height:44,justifyContent:'center',alignItems:'center'}}>
  ...
  fontStyle: "normal",}}>
               {strings("insurancecompanies.lowtohigh", lang)}
                ...
                <TouchableOpacity    onPress={()=>{this.props.showSortingModal(!show_sort_modal)}}style={{width:'100%',height:44,justifyContent:'center',alignItems:'center'}}>
...
const mapStateToProps = state => {
  ...
  const {
    ...
    addons,
    terms,
    show_pdf_modal,insurancecompaniesTravel,insurance_loading
  } = state.insuranceCompaniesReducer;
  return {show_insurance_modal, addons, terms, lang, show_pdf_modal,show_sort_modal,insurancecompaniesTravel,insurance_loading};
};
